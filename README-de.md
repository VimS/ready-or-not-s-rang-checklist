...
- 💡 **Tipps** - Für besonders knifflige Missionen (als Spoiler versteckt)
- 🌐 **Zweisprachig** - Deutsch & Englisch Unterstützung
- 🌙 **Dark Mode** - Komfortables dunkles Theme
...
**URL:** `https://dein-username.github.io/ready-or-not-s-rang-checklist`

### Lokal
```bash
# Repository clonen
git clone https://github.com/dein-username/ready-or-not-s-rang-checklist.git
...
- Persönlich (nur du kannst deine Daten sehen)
- Dauerhaft (bis du deinen Browser-Cache löschst)

**Daten exportieren:** Kopiere aus der Browser-Konsole:
```javascript
...
Bearbeite das `translations`-Objekt im `<script>`-Bereich, um neue Sprachen hinzuzufügen oder bestehende Übersetzungen zu aktualisieren.

## 🤝 Zusammenarbeit

Du kannst anderen GitHub-Nutzern Zugriff auf dieses Repository geben:

### Collaborators hinzufügen (Privates Repo)
1. Gehe zu deinem Repository auf GitHub
2. **Settings** → **Collaborators and teams** (oder **Collaborators**)
3. Klicke **Add people**
4. Gib den GitHub-Username, die E-Mail oder den vollständigen Namen ein
5. Wähle die Berechtigung (Push access empfohlen)
6. Die Person erhält eine Einladung per E-Mail

### Berechtigungsstufen
- **Pull**: Nur lesen
- **Push**: Lesen + Bearbeiten (empfohlen für Collaborators)
- **Admin**: Vollständiger Zugriff, inkl. Einstellungen
...
- 🇬🇧 **English** - [README.md](README.md) (Hauptversion)
- 🇩🇪 **Deutsch** - [README-de.md](README-de.md)

Die Sprache in der App kann über den 🌐 Button rechts oben umgeschaltet werden.

## 🐛 Probleme?

- **Fortschritt weg?** → Dein Browser-Cache wurde geleert (localStorage)
- **Styling fehlerhaft?** → Browser-Cache leeren (Strg+Shift+Entf)
